...
class VendorsAndCustomersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vendors_and_customers, container, false)

        // Find the button by ID
        val openNewActivityButton: ImageView? = view?.findViewById(R.id.empty_vendorsandcustomers_icon)
