 ...
 */
class PartsAndSuppliesDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_parts_and_supplies_details, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            PartsAndSuppliesDetailsFragment().apply {
