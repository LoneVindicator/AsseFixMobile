...
class Datasource() {
    ...
    fun loadWorkOrderCards(): List<WorkOrderCards> {
        return listOf<WorkOrderCards>(
            ...
            WorkOrderCards("456789", "On Hold", "Critical", "Inspection", "Elevator", "Bob Johnson", "04/05/22"),
            ...
            WorkOrderCards("135792", "Pending", "Critical", "Inspection", "Security System", "Matthew Turner", "11/12/19"),
