 ...
 */
class InspectionsAndSupervisionDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_inspections_and_supervision_details, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            InspectionsAndSupervisionDetailsFragment().apply {
